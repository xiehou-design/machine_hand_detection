from Hand.model_hand_1.dataset import HandDataset
...
if __name__ == '__main__':
    ...
    train_dataset = HandDataset(image_dir='../data/hand1', txt_filepath='../data/train.txt', transform=train_transform)
    test_dataset = HandDataset(image_dir='../data/hand1', txt_filepath='../data/test.txt', transform=test_transformer)
